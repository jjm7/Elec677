...
\begin{figure*}[ht]
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2.5in]{figures/5layer_20_16_10_4_4_lossPt69_tanh_circles1.png}
    \end{subfigure}%
 ...
 \label{fig:hihi}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2.5in]{figures/5layer_20_16_10_4_4_lossPt69_tanh_circles.png}
    \end{subfigure}
...
\begin{figure*}[ht]
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/layer1a_hist.png}
    \end{subfigure}%
 ...
 \label{fig:/layer1a_hist1}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/layer1b_hist.png}
    \end{subfigure}%
    \caption{Histogram of biases in  layer one for all iterations}
 \label{fig:/layer1b_hist1}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/layer1i_hist.png}
    \end{subfigure}%
 ...
 \label{fig:/layer1i_hist1}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/layer1mp_hist.png}
    \end{subfigure}%
...
\begin{figure*}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/layer1w_hist.png}
    \end{subfigure}%
    \caption{Histogram of weights in  layer one for all iterations}
...
\begin{figure*}[ht]
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/layer2a_hist.png}
    \end{subfigure}%
    \caption{Histogram of activations in layer one for all iterations}
 \label{fig:/layer2a_hist1}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/layer2b_hist.png}
    \end{subfigure}%
    \caption{Histogram of biases in  layer one for all iterations}
 \label{fig:/layer2b_hist1}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/layer2i_hist.png}
    \end{subfigure}%
    \caption{Histogram of  inputs in  layer one for all iterations}
 \label{fig:/layer2i_hist1}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/layer2mp_hist.png}
    \end{subfigure}%
    \caption{Histogram of activations after max pooling in  layer one for all iterations}
...
\begin{figure*}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/layer2w_hist.png}
    \end{subfigure}%
    \caption{Histogram of weights in layer one for all iterations}
...
\begin{figure*}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/ReLU_Adagrad_X/trainingError.png}
    \end{subfigure}%
...
\begin{figure*}[ht]
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/layer1a_hist.png}
    \end{subfigure}%
    \caption{Histogram of activations in layer one for all iterations}
 \label{fig:/layer1a_hist2}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/layer1b_hist.png}
    \end{subfigure}%
    \caption{Histogram of biases in  layer one for all iterations}
 \label{fig:/layer1b_hist2}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/layer1i_hist.png}
    \end{subfigure}%
    \caption{Histogram of  inputs in  layer one for all iterations}
 \label{fig:/layer1i_hist2}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/layer1mp_hist.png}
    \end{subfigure}%
    \caption{Histogram of activations after max pooling in  layer one for all iterations}
...
\begin{figure*}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/layer1w_hist.png}
    \end{subfigure}%
    \caption{Histogram of weights in  layer one for all iterations}
...
\begin{figure*}[ht]
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/layer2a_hist.png}
    \end{subfigure}%
    \caption{Histogram of activations in layer one for all iterations}
 \label{fig:/layer2a_hist2}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/layer2b_hist.png}
    \end{subfigure}%
    \caption{Histogram of biases in  layer one for all iterations}
 \label{fig:/layer2b_hist2}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/layer2i_hist.png}
    \end{subfigure}%
    \caption{Histogram of  inputs in  layer one for all iterations}
 \label{fig:/layer2i_hist2}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/layer2mp_hist.png}
    \end{subfigure}%
    \caption{Histogram of activations after max pooling in  layer one for all iterations}
...
\begin{figure*}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/layer2w_hist.png}
    \end{subfigure}%
    \caption{Histogram of weights in layer one for all iterations}
...
\begin{figure*}
    ...
    \begin{subfigure}
        \centering
        \includegraphics[height=2in]{figures/LReLU_X_SGD_lrM/trainingError.png}
    \end{subfigure}%
    \caption{Training Error for all iterations}
