...
class Layer():
        ...
        def feedforward(self, X, middle_layer=True):
            ...
            output = self.a if middle_layer else self.z
            return output
...
def main():
    ...
    model = DeepNeuralNetwork(nn_input_dim=2, nn_output_dim=2, num_hlayers=2, layer_sizes=[4,8], actFun_type='tanh')
    model.fit_model(X,y, epsilon=.01, num_passes=10000)
